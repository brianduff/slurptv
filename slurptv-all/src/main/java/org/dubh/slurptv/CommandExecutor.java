...
public final class CommandExecutor {
  ...
  public void execute(Collection<String> command, String label) throws IOException, InterruptedException {
  ...
  public void execute(String[] command, String label) throws IOException, InterruptedException {
    ...
    if (process.waitFor() != 0) {
      throw new IOException("Error from " + name + "." + label + ". Command=" + Joiner.on(' ').join(command));
    }

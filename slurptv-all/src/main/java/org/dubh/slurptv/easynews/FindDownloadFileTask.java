...
public class FindDownloadFileTask extends AbstractTask {
  ...
  public EpisodeState perform(Show show, EpisodeState previousState) throws TaskFailedException {
		...
		ImmutableSet<ResultFilter> filters = ImmutableSet.of(
				new AtLeastSizeFilter(minSize),
				new NoBiggerThanFilter(maxSize),
		...
		Query query = new Query()
				.setShowTitle(show.getName())
				.setEpisode(previousState.getEpisode());
